...
object decode_record(string rbuff) {
  [srcaddr,dstaddr,nexthop,input,output,dPkts,dOctets,first,last,srcport,dstport,prot,tos,tcp_flags] = array_sscanf(rbuff, "%4c%4c%4c%2c%2c%4c%4c%4c%4c%2c%2c%2*c%c%c%c%8*c");
  return this_object();
}
